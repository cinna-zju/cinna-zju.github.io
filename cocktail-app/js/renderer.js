...
const showCocktailDetail = (cocktail) => {
  ...
  if (elements.detailName) elements.detailName.textContent = cocktail.name
  if (elements.detailNameEn) elements.detailNameEn.textContent = cocktail.nameEn
  ...
  if (elements.detailSpirit) elements.detailSpirit.textContent = cocktail.baseSpirit
  if (elements.detailAlcohol) elements.detailAlcohol.textContent = cocktail.alcoholContent
  if (elements.detailDifficulty) elements.detailDifficulty.textContent = cocktail.difficulty
  if (elements.detailGlass) elements.detailGlass.textContent = cocktail.glassType
  ...
  if (elements.detailGarnish) elements.detailGarnish.textContent = cocktail.garnish
  ...
  if (elements.detailHistory) elements.detailHistory.textContent = cocktail.history
